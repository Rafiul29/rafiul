...
export function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-50 via-slate-100/80 to-blue-50/60 dark:from-black dark:via-gray-950 dark:to-slate-950 border-t border-gray-200 dark:border-gray-800">
